...
function init_flot_chart() {
  if (void 0 !== $.plot) {
    ...
    ], o = 0; o < 30; o++) t.push([new Date(Date.today().add(o).days()).getTime(),
...
function init_gauge() {
  if ('undefined' != typeof Gauge) {
    ...
    if ($('#gauge-text').length && (t.maxValue = 6000, t.animationSpeed = 32, t.set(3200), t.setTextField(document.getElementById('gauge-text'))), $('#chart_gauge_02').length) var o = document.getElementById('chart_gauge_02'),
    n = new Gauge(o).setOptions(e);
    $('#gauge-text2').length && (n.maxValue = 9000, n.animationSpeed = 32, n.set(2400), n.setTextField(document.getElementById('gauge-text2')))
  }
}
function init_sparklines() {
  void 0 !== jQuery.fn.sparkline && (console.log('init_sparklines'), $('.sparkline_one').sparkline([2,
  4,
  3,
  4,
  5,
  ...
  if (void 0 !== $.fn.cropper) {
    ...
    $('.docs-buttons').on('click', '[data-method]', function () {
      ...
      if (!t.prop('disabled') && !t.hasClass('disabled') && i.data('cropper') && o.method) {
        if (void 0 !== (o = $.extend({
        }, o)).target && (e = $(o.target), void 0 === o.option)) try {
...
function init_knob() {
  if (void 0 !== $.fn.knob) {
    ...
    $('input.infinite').knob({
      ...
      stopper: !1,
      change: function () {
        e > this.cv ? a ? (o--, n.show().html('-').fadeOut(), i.html(o), a = 0) : (a = 1, t = 0) : e < this.cv && (t ? (o++, n.show().html('+').fadeOut(), i.html(o), t = 0) : (t = 1, a = 0)),
        e = this.cv
      }
    })
  }
...
function init_EasyPieChart() {
  if (void 0 !== $.fn.easyPieChart) {
    ...
    $.fn.popover.Constructor.prototype.leave = function (e) {
      ...
      n.call(this, e),
      e.currentTarget && (a = $(e.currentTarget).siblings('.popover'), t = o.timeout, a.one('mouseenter', function () {
        clearTimeout(t),
...
function init_charts() {
  if (console.log('run_charts  typeof [' + typeof Chart + ']'), 'undefined' != typeof Chart) {
    ...
    if ($('#polarArea').length) e = document.getElementById('polarArea'),
    a = {
      datasets: [
        {
          data: [
